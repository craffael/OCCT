...
if (EXECUTABLE_PROJECT)
  ...
  target_include_directories(${PROJECT_NAME} PUBLIC $<INSTALL_INTERFACE:${INSTALL_DIR_INCLUDE}>)

  if (MSVC)
    install (FILES  ${CMAKE_BINARY_DIR}/${OS_WITH_BIT}/${COMPILER}/bin\${OCCT_INSTALL_BIN_LETTER}/${PROJECT_NAME}\${OCCT_INSTALL_BIN_LETTER}.pdb
